    ...
    <>
      ...
      <main className='flex w-full flex-col items-center justify-center dark:text-light'>
        <Layout className='pt-16'>
          <AnimatedText text='Acerca de mí' className='mb-16'/>
          <div className='grid w-full grid-cols-8 gap-16'>
            ...
            <div className='col-span-2 flex flex-col items-end justify-between'>
                <div className='flex flex-col items-end justify-center'>
                  ...
                  <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>Empresas colaboradas</h2>
                </div>
                <div className='flex flex-col items-end justify-center'>
                  <span className='inline-block text-7xl font-bold'>
                  <AnmimatedNumbers value={5}/> +
                  </span>
                  <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>Meses de experiencia</h2>
                </div>
                <div className='flex flex-col items-end justify-center'>
                  <span className='inline-block text-7xl font-bold'>
                  <AnmimatedNumbers value={5}/> +
                  </span>
                  <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>Certificaciones</h2>
                </div>
            </div>
          </div>
          <Skills/>
