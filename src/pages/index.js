        ...
        <Layout className='pt-0'>
          <div className='flex items-center justify-between w-full gap-8'>
            ...
            <div className='flex items-center self-start mt-2'>
              ...
              <Link href="/projects" className='ml-4 text-lg font-medium capitalize text-dark underline dark:text-light'>Proyectos</Link>
            </div>
          </div>
        </div>
        </Layout>
