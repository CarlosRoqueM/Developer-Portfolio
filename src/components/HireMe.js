...
const HireMe = () => {
return (
    <div className='fixed right-3 bottom-3 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0 sm:-top-3'>
